"""retail_test_24152 URL Configuration
...
admin.site.site_header = "retail_test"
admin.site.site_title = "retail_test Admin Portal"
admin.site.index_title = "retail_test Admin"

# swagger
api_info = openapi.Info(
    title="retail_test API",
    default_version="v1",
    description="API documentation for retail_test App",
)
